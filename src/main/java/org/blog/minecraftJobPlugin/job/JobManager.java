...
public class JobManager {
    ...
    /**
     * 플레이어가 보유한 모든 직업 목록 반환 (UUID 버전 - Set)
     */
    ...
    /**
     * 플레이어가 보유한 모든 직업 목록 반환 (Player 버전 - Set)
     */
    ...
    public void addJob(Player player, String jobName) {
        ...
        if (job != null && plugin.getEquipmentManager() != null) {
